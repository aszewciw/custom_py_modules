...
'''
Description:
    Conversions between various coordinate systems for astro objects.
'''

__all__        =['eq2cart','cart2eq','eq2gal','gal2eq','gal2ZR','dot','cross','rodrigues']
__copyright__  =["Copyright 2014? Qingqing Mao, coordinate transformations; modified by Adam Szewciw"]
